...
class Base():
    ...
    def to_json(self, for_serialization: bool = False) -> dict:
        """Convert tha object a JSON dictionary.
        """
        result = {}
    ...
    def load_from_file(cls):
        """Load all tha objects from file.
        """
    ...
    def get(cls, id: str) -> TypeVar('Base'):
        """Return one of tha object by ID.
        """
        s_class = cls.__name__
    ...
    def search(cls, attributes: dict = {}) -> List[TypeVar('Base')]:
        """Search all objects with tha matching attributes.
        """
        s_class = cls.__name__
        def _search(obj):
            if len(attributes) == 0:
